  ...
  <div>
    ...
    <div class="center-main">
      ...
      >
        ...
        <el-form-item label="物种图片" prop="name" style="width:500px" class="uploda">
          <el-upload
            class="upload-demo"
        ...
        <!-- 物种介绍 -->
        <el-form-item label="环境介绍" prop="desc" style="width:376px" class="desc">
        ...
        >
          <el-checkbox-group v-model="checkList" >
            <el-checkbox label="城市生态链" v-model="checkList" @change="handle"></el-checkbox>
            <el-checkbox label="森林生态链" v-model="checkList" @change="handle1"></el-checkbox>
          </el-checkbox-group>
        </el-form-item>

        <el-form-item class="e-btn">
          <router-link to="/home/species">
...
export default {
  ...
  mounted () {
    // 读取localStory数据
    var infoStr = localStorage.getItem('editSpecies')
  ...
  methods: {
    submitForm () {
      ...
      axios({
        ...
        data: {
          ...
          is_ready: 0,
          pic: 'b64encode image',
          belong_envs: this.ruleForm.belong_envs
        }
      }).then(res => {
        console.log(res)
      })
    ...
    handle () {
      this.ruleForm.belong_envs = ''
      // console.log(ruleForm.belong_envs=this.checkList[1])
      this.ruleForm.belong_envs = this.checkList[0]
      console.log(this.ruleForm.belong_envs)
    },
    handle1 () {
      this.ruleForm.belong_envs = ''
      // console.log(ruleForm.belong_envs=this.checkList[1])
      this.ruleForm.belong_envs = this.checkList[1]
      console.log(this.ruleForm.belong_envs)
    }
