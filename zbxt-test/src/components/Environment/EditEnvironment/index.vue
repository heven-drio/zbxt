    ...
    <div class="center-main">
      ...
      >
        <el-form-item label="环境名称" prop="name" style="width:500px">
          ...
          <!-- <el-input placeholder="环境的名称">{{this.$route.params.id}}</el-input> -->
        </el-form-item>
        ...
        <el-form-item class="a-el-checkbox">
          <el-checkbox v-model="ruleForm.is_ready"  @change="check" class="a-el-checkbox2">物种已备齐</el-checkbox>
        </el-form-item>
...
export default {
  ...
  mounted () {
    // 读取localStory数据
    var infoStr = localStorage.getItem('editEn')
