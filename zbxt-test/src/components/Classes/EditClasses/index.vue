      ...
      <div class="ac-main">
        ...
        <div class="sub-btn">
          <el-row>
             ...
             <el-button type="primary" class="btn1" size="mini" @click="submit">提交</el-button>
             </router-link>
...
export default {
  ...
  mounted () {
    // 读取localStory数据
    var infoStr = localStorage.getItem('editClass')
  ...
  methods: {
    ...
    submit () {
      axios({
        method: 'post',
        url: 'http://192.168.94.60:8000/teacher/class/edit/',
        headers: {
        ...
        data: {
          ...
          class_num: this.ruleForm.class_num,
          groups_count: this.ruleForm.groups_count
        }
      }).then(res => {
        console.log(res)
      })
